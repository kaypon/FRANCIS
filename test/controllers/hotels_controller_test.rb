...
class HotelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hotel" do
    assert_difference('Hotel.count') do
      post hotels_url, params: { hotel: { password: @hotel.password, user_name: @hotel.user_name } }
    end
  ...
  test "should update hotel" do
    patch hotel_url(@hotel), params: { hotel: { password: @hotel.password, user_name: @hotel.user_name } }
